...
<div class="section" id="results-section" style="display:none;">
  <h2>3️⃣ Source à copier‑coller</h2>
  <pre id="sourceOutput"></pre>
  <h2>4️⃣ Prompt d’exécution vidéo à copier‑coller</h2>
...
function generateNotebook() {
  ...
  lines.forEach((line, idx) => {
    const char = line.querySelector('.character').value === "A" ? "Personnage A" : "Personnage B";
    ...
    if(text.length > 0){
      source += `${char} (${style}): ${text} [PAUSE ${pause}s]\n`;
    }
  });
